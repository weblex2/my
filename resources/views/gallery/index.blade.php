...
<x-gallery-layout>
    ...
    <div id="create-gallery-modal" class="{{$cg_invisible}} absolute z-10 bg-zinc-900 bg-opacity-80 top-0 left-0 w-screen h-screen flex items-center justify-center">
      <div class="bg-zinc-800 rounded px-10 py-10 relative w-[500px]">
        <div class="absolute top-0 right-0 m-3 shadow-xl cursor-pointer" onclick="$('#create-gallery-modal').css('visibility', 'hidden')"><i class="text-orange-500 fa-solid fa-xmark"></i></div>
        ...
        <form id="frmCreateBlog" action="{{route('gallery.store')}}" method="post">
          ...
          <button type="submit" class="px-5 py-3 my-4 border rounded-xl bg-zinc-700 border-zinc-900">Create</button>

          @if (($message = Session::get('error')))
            <div class="p-5 mb-5 text-black bg-red-300 border-red-900 rounded-xl">
    ...
    <div id="create-mappoint-modal" class="{{$cg_invisible}} modal">
      <div class="bg-zinc-800 rounded px-10 py-10 relative w-[500px]">
        <div class="absolute top-0 right-0 m-3 shadow-xl cursor-pointer" onclick="$('#create-mappoint-modal').css('visibility', 'hidden')"><i class="text-orange-500 fa-solid fa-xmark"></i></div>
