...
@section('content')
    ...
    <table class="tblLaravelMyAdmin">
        ...
        @foreach ($tables as $table)
            <tr>
            <td><a href="{{ route("laravelMyAdmin.showTableStructure", ["db" => $db, 'table' => $table->TABLE_NAME]) }}">{{$table->TABLE_NAME}}</a></td>
            ...
            <td><i class="fa-solid fa-eraser action-icon"></i><a href="#" onclick=truncateTable('{{$table->TABLE_NAME}}') >Truncate</a></td>
