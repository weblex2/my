...
<nav x-data="{ open: false }" class="{{$bgColor}} border-b {{$bgBorder}}">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{asset('img/noppal.jpg')}}" class="h-[50px] w-[50px] block w-auto rounded-full">
            ...
            @if ( Auth()->check()) 
            <div class="hidden sm:flex sm:items-center sm:ml-6 {{$bgColor}}">
                <!-- Teams Dropdown -->
                @if (Laravel\Jetstream\Jetstream::hasTeamFeatures() && !Route::is('gallery*'))
