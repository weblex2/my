    ...
    <div class="calendar-wrapper">
        ...
        <div class="day1 " date={{$datesdb[0]}}>
            @isset($ft[$datesdb[0]]['img'])
                <img src="{{$ft[$datesdb[0]]['img']}}" class="w-full h-full">
            @endisset
        </div>
        <div class="day1" date={{$datesdb[1]}}>
            @isset($ft[$datesdb[1]]['img'])
                <img src="{{$ft[$datesdb[1]]['img']}}" class="w-full h-full">
            @endisset
        </div>
        <div class="day1" date={{$datesdb[2]}}>
            @isset($ft[$datesdb[2]]['img'])
                <img src="{{$ft[$datesdb[2]]['img']}}" class="w-full h-full">
            @endisset
        </div>
        <div class="day1" date={{$datesdb[3]}}>
            @isset($ft[$datesdb[3]]['img'])
                <img src="{{$ft[$datesdb[3]]['img']}}" class="w-full h-full">
            @endisset
        </div>
        <div class="day1" date={{$datesdb[4]}}>
            @isset($ft[$datesdb[4]]['img'])
                <img src="{{$ft[$datesdb[4]]['img']}}" class="w-full h-full">
            @endisset
        </div>
        <div class="day1" date={{$datesdb[5]}}>
            @isset($ft[$datesdb[5]]['img'])
                <img src="{{$ft[$datesdb[5]]['img']}}" class="w-full h-full">
            @endisset
        </div>
        <div class="day1" date={{$datesdb[6]}}>
            @isset($ft[$datesdb[6]]['img'])
                <img src="{{$ft[$datesdb[6]]['img']}}" class="w-full h-full">
            @endisset
        </div>
    </div>
</div>
